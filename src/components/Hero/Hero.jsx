  ...
  return (
    <section className="min-h-screen flex items-center pt-36">
      <div className="mx-auto w-[92%] max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
        ...
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel nulla esse suscipit molestiae facilis libero eos itaque eaque aperiam tenetur! Velit magni eveniet sed architecto itaque, corporis accusamus voluptatem culpa.
      </div>
